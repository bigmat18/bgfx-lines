...
namespace lines {
    ...
    void InstancingBasedPolylines::generateIDBSegments(const std::vector<LinesVertex> &points) {
    ...
    void InstancingBasedPolylines::generateIDBJoins(const std::vector<LinesVertex> &points) {
