...
namespace lines {
    ...
    IndirectBasedPolylines::IndirectBasedPolylines(const IndirectBasedPolylines& other) : Polylines(other) {
    ...
    IndirectBasedPolylines::IndirectBasedPolylines(IndirectBasedPolylines&& other) : Polylines(other) {
        swap(other);
    }
