...
namespace lines {
    GPUGeneratedLines::GPUGeneratedLines(const std::vector<LinesPoint> &points, const float width, const float heigth) : 
        Lines(width, heigth, "cpu_generated_lines/vs_cpu_generated_lines", "cpu_generated_lines/fs_cpu_generated_lines")
    {
        ...
        m_PointsBuffer = bgfx::createDynamicVertexBuffer(
            bgfx::makeRef(&points[0], sizeof(LinesPoint) * points.size()),
            layoutPointsBuffer,
